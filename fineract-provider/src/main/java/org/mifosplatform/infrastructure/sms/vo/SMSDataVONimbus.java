...
public class SMSDataVONimbus implements Serializable {
	...
	public SMSDataVONimbus(final String smsTemplateType, final String phoneNo, final String templateParameterString,final String templateConentType) {
