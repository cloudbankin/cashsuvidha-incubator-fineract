...
public interface ReadWriteNonCoreDataService {
    ...
    CommandProcessingResult createNewDatatableEntry(String datatable, Long appTableId, String json,Long commandId);
    ...
    String getMailIdForColumn(Long loanId,String mailDataTableName,String mailDataColumnName) ;
    
    File getFile(final MultivaluedMap<String, String> reportParams, final String reportName,final StringBuilder errorLog,final String pdf) ;
    
    Map<String, String> getReportParams(final MultivaluedMap<String, String> queryParams);
}