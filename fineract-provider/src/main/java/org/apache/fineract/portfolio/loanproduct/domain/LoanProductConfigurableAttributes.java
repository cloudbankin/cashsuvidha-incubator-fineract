...
public class LoanProductConfigurableAttributes extends AbstractPersistableCustom<Long> {
    ...
    @Column(name = "invoice_method_enum", nullable = true)
	...
	private static final String[] supportedloanConfigurableAttributes = {LoanProductConstants.amortizationTypeParamName,
			LoanProductConstants.interestTypeParamName,LoanProductConstants.invoiceTypeParamName , LoanProductConstants.transactionProcessingStrategyIdParamName,
    ...
    public static LoanProductConfigurableAttributes createFrom(JsonCommand command) {
        ...
        final Boolean invoiceMethod = command.parsedJson().getAsJsonObject()
                .getAsJsonObject(LoanProductConstants.allowAttributeOverridesParamName)
        ...
        return new LoanProductConfigurableAttributes(amortization, interestMethod, invoiceMethod, transactionProcessingStrategy, interestCalcPeriod,
    ...
    public static LoanProductConfigurableAttributes populateDefaultsForConfigurableAttributes() {
        ...
        final Boolean invoiceMethod = true;
    ...
    public LoanProductConfigurableAttributes(Boolean amortization, Boolean interestMethod, Boolean invoiceMethod, Boolean transactionProcessingStrategy,
        ...
        this.invoiceType = invoiceMethod;
    ...
    public Boolean getInvoiceMethodBoolean() {
        return invoiceType;
    }
