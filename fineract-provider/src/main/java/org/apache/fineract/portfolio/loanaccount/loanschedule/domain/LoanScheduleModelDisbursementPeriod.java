...
public final class LoanScheduleModelDisbursementPeriod implements LoanScheduleModelPeriod {
    ...
    private final BigDecimal interestBrokenChargesDueAtTimeOfDisbursement;
    
    public static LoanScheduleModelDisbursementPeriod disbursement(final LoanApplicationTerms loanApplicationTerms,
            final BigDecimal chargesDueAtTimeOfDisbursement ,final BigDecimal interestBrokenChargesDueAtTimeOfDisbursement) {
        ...
        return new LoanScheduleModelDisbursementPeriod(periodNumber, loanApplicationTerms.getExpectedDisbursementDate(),
                loanApplicationTerms.getPrincipal(), chargesDueAtTimeOfDisbursement ,interestBrokenChargesDueAtTimeOfDisbursement);
    }
    ...
    public static LoanScheduleModelDisbursementPeriod disbursement(final LocalDate disbursementDate, final Money principalDisbursed,
            final BigDecimal chargesDueAtTimeOfDisbursement , final BigDecimal interestBrokenChargesDueAtTimeOfDisbursement) {
        return new LoanScheduleModelDisbursementPeriod(null, disbursementDate, principalDisbursed, chargesDueAtTimeOfDisbursement ,interestBrokenChargesDueAtTimeOfDisbursement);
    }

    private LoanScheduleModelDisbursementPeriod(final Integer periodNumber, final LocalDate disbursementDate,
            final Money principalDisbursed, final BigDecimal chargesDueAtTimeOfDisbursement , final BigDecimal interestBrokenChargesDueAtTimeOfDisbursement) {
        this.periodNumber = periodNumber;
        this.disbursementDate = disbursementDate;
        this.principalDisbursed = principalDisbursed;
        this.chargesDueAtTimeOfDisbursement = chargesDueAtTimeOfDisbursement;
        this.interestBrokenChargesDueAtTimeOfDisbursement = interestBrokenChargesDueAtTimeOfDisbursement;
    }
    ...
    public LoanSchedulePeriodData toData() {
        return LoanSchedulePeriodData.disbursementOnlyPeriod(this.disbursementDate, this.principalDisbursed.getAmount(),
                this.chargesDueAtTimeOfDisbursement ,this.interestBrokenChargesDueAtTimeOfDisbursement, false);
    }
