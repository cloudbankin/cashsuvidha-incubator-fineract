...
public interface LoanApiConstants {
    ...
    public static final String sendmailParameterName = "sendmail";
    public static final String repaymentmailParamaterName = "repaymentmail";
    public static final String loanclosuremailParamaterName = "loanclosuremail";
    ...
    public static final String invoiceTypeParameterName = "invoiceType";
    ...
    public static final String amountReturnParameterName = "amountReturn";
    ...
    public static final String repaymentScheduleId = "repaymentScheduleId";
    public static final String ispaymentcharges = "ispaymentcharges";
}
