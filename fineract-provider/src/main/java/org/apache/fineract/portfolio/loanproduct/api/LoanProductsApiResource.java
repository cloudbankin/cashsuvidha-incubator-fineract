...
public class LoanProductsApiResource {
    ...
    private final Set<String> LOAN_PRODUCT_DATA_PARAMETERS = new HashSet<>(Arrays.asList("id", "name", "shortName", "description",
            ...
            "maxInterestRatePerPeriod", "interestRateFrequencyType", "annualInterestRate", "amortizationType", "interestType","invoiceType",
            ...
            "repaymentFrequencyTypeOptions", "interestRateFrequencyTypeOptions", "amortizationTypeOptions", "interestTypeOptions","invoiceTypeOptions",
    ...
    private LoanProductData handleTemplate(final LoanProductData productData) {
        ...
        final List<EnumOptionData> invoiceTypeOptions = this.dropdownReadPlatformService.retrieveLoanInvoiceTypeOptions();
        ...
        return new LoanProductData(productData, chargeOptions, penaltyOptions, paymentTypeOptions, currencyOptions,
                amortizationTypeOptions, interestTypeOptions,  invoiceTypeOptions, interestCalculationPeriodTypeOptions, repaymentFrequencyTypeOptions,
