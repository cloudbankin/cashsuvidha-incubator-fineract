...
import org.apache.fineract.portfolio.loanproduct.domain.InvoiceMethod;
...
public final class LoanApplicationTerms {
    ...
    private final InvoiceMethod invoiceMethod;
    ...
    public final DaysInMonthType daysInMonthType;

    public final DaysInYearType daysInYearType;
    ...
    public static LoanApplicationTerms assembleFrom(final ApplicationCurrency currency, final Integer loanTermFrequency,
            ...
            final AmortizationMethod amortizationMethod, final InterestMethod interestMethod,final InvoiceMethod invoiceMethod, final BigDecimal interestRatePerPeriod,
            ...
            final Integer graceOnInterestCharged, final LocalDate interestChargedFromDate, final BigDecimal amountReturn, final Money inArrearsTolerance,
        ...
        return new LoanApplicationTerms(currency, loanTermFrequency, loanTermPeriodFrequencyType, numberOfRepayments, repaymentEvery,
                repaymentPeriodFrequencyType, nthDay, weekDayType, amortizationMethod, interestMethod, invoiceMethod, interestRatePerPeriod,
                ...
                interestChargedFromDate, amountReturn, inArrearsTolerance, multiDisburseLoan, emiAmount, disbursementDatas, maxOutstandingBalance,
    ...
    public static LoanApplicationTerms assembleFrom(final ApplicationCurrency applicationCurrency, final Integer loanTermFrequency,
            ...
            final LocalDate interestChargedFromDate, final BigDecimal amountReturn, final BigDecimal principalThresholdForLastInstalment,
        ...
        return assembleFrom(applicationCurrency, loanTermFrequency, loanTermPeriodFrequencyType, nthDay, dayOfWeek,
                ...
                loanProductRelatedDetail, multiDisburseLoan, emiAmount, disbursementDatas, maxOutstandingBalance, interestChargedFromDate, amountReturn,
    ...
    public static LoanApplicationTerms assembleFrom(final ApplicationCurrency applicationCurrency, final Integer loanTermFrequency,
        ...
        final InvoiceMethod invoiceMethod = loanProductRelatedDetail.getInvoiceMethod();
        ...
        return new LoanApplicationTerms(applicationCurrency, loanTermFrequency, loanTermPeriodFrequencyType, numberOfRepayments,
                ...
                interestMethod, invoiceMethod, interestRatePerPeriod, interestRatePeriodFrequencyType, annualNominalInterestRate,
                ...
                graceOnInterestCharged, interestChargedFromDate, amountReturn, inArrearsTolerance, multiDisburseLoan, emiAmount, disbursementDatas,
    ...
    public static LoanApplicationTerms assembleFrom(final ApplicationCurrency applicationCurrency, final Integer loanTermFrequency,
            ...
            final LocalDate interestChargedFromDate, final BigDecimal amountReturn, final LoanInterestRecalculationDetails interestRecalculationDetails,
        ...
        return new LoanApplicationTerms(applicationCurrency, loanTermFrequency, loanTermPeriodFrequencyType, numberOfRepayments,
                repaymentEvery, repaymentPeriodFrequencyType, null, null, amortizationMethod, interestMethod, invoiceMethod, interestRatePerPeriod,
                interestRatePeriodFrequencyType, annualNominalInterestRate, interestCalculationPeriodMethod,
                allowPartialPeriodInterestCalcualtion, principalMoney, expectedDisbursementDate, repaymentsStartingFromDate,
                calculatedRepaymentsStartingFromDate, graceOnPrincipalPayment, recurringMoratoriumOnPrincipalPeriods, graceOnInterestPayment, graceOnInterestCharged,
                interestChargedFromDate, amountReturn, inArrearsTolerance, multiDisburseLoan, emiAmount, disbursementDatas, maxOutstandingBalance,
    ...
    public static LoanApplicationTerms assembleFrom(final LoanApplicationTerms applicationTerms,
        ...
        return new LoanApplicationTerms(applicationTerms.currency, applicationTerms.loanTermFrequency,
                ...
                applicationTerms.amortizationMethod, applicationTerms.interestMethod, applicationTerms.invoiceMethod, applicationTerms.interestRatePerPeriod,
                ...
                applicationTerms.recurringMoratoriumOnPrincipalPeriods, applicationTerms.interestPaymentGrace, applicationTerms.interestChargingGrace, applicationTerms.interestChargedFromDate, applicationTerms.amountReturn,
    ...
    private LoanApplicationTerms(final ApplicationCurrency currency, final Integer loanTermFrequency,
            ...
            final Integer interestChargingGrace, final LocalDate interestChargedFromDate, final BigDecimal amountReturn, final Money inArrearsTolerance,
            final boolean multiDisburseLoan, final BigDecimal emiAmount, final List<DisbursementData> disbursementDatas,
            final BigDecimal maxOutstandingBalance, final Integer graceOnArrearsAgeing, final DaysInMonthType daysInMonthType,
            final DaysInYearType daysInYearType, final boolean isInterestRecalculationEnabled,
...
//        numPeriods = numPeriods - this.periodsCompleted;
    ...
    public LoanProductRelatedDetail toLoanProductRelatedDetail() {
        ...
        return LoanProductRelatedDetail.createFrom(currency, this.principal.getAmount(), this.interestRatePerPeriod,
                this.interestRatePeriodFrequencyType, this.annualNominalInterestRate, this.interestMethod, this.invoiceMethod,
   ...
   public void updateAmountReturn(BigDecimal amountReturn) {
    ...
    public Money getTotalDisbursedAmountForInterestBroken() {
        Money disbursedAmount = Money.zero(getCurrency());
        if (isMultiDisburseLoan()) {
            for (DisbursementData disbursement : getDisbursementDatas()) {
                    disbursedAmount = disbursedAmount.plus(disbursement.amount());
