...
public final class CalculateLoanScheduleQueryFromApiJsonHelper {
    ...
    final Set<String> supportedParameters = new HashSet<>(Arrays.asList(LoanApiConstants.idParameterName,
            ...
            LoanApiConstants.amortizationTypeParameterName, LoanApiConstants.interestTypeParameterName, LoanApiConstants.invoiceTypeParameterName,
            ...
            LoanApiConstants.graceOnInterestChargedParameterName, LoanApiConstants.interestChargedFromDateParameterName, LoanApiConstants.amountReturnParameterName,
