...
public class CreocoreLoanRepaymentScheduleTransactionProcessor extends AbstractLoanRepaymentScheduleTransactionProcessor {
    ...
    protected Money handleTransactionThatIsPaymentInAdvanceOfInstallment(final LoanRepaymentScheduleInstallment currentInstallment,
        ...
        return handleTransactionThatIsOnTimePaymentOfInstallment(currentInstallment, loanTransaction, paymentInAdvance, transactionMappings,isExcludeCharges, habLoanRepaymentSchedule, isRepaymentCharge);
    }
    ...
    protected Money handleTransactionThatIsOnTimePaymentOfInstallment(final LoanRepaymentScheduleInstallment currentInstallment,
            ...
            final List<LoanTransactionToRepaymentScheduleMapping> transactionMappings, final boolean isExculdeCharges, final Set<HabLoanRepaymentSchedule> habLoanRepaymentSchedule
            , final boolean isRepaymentCharge) {
