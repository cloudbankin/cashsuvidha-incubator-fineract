...
public class LoansApiResource {
    ...
    private final Set<String> LOAN_DATA_PARAMETERS = new HashSet<>(Arrays.asList("id", "accountNo", "status", "externalId", "clientId",
            ...
            "transactionProcessingStrategyName", "interestRateFrequencyType", "amortizationType", "interestType","invoiceType",
            ...
            "graceOnPrincipalPayment", "recurringMoratoriumOnPrincipalPeriods", "graceOnInterestPayment", "graceOnInterestCharged", "interestChargedFromDate","amountReturn", "timeline",
            "totalFeeChargesAtDisbursement", "summary", "repaymentSchedule", "transactions", "charges", "collateral", "guarantors",
            "meeting", "productOptions", "amortizationTypeOptions", "interestTypeOptions","invoiceTypeOptions", "interestCalculationPeriodTypeOptions",
    ...
    public String retrieveLoan(@PathParam("loanId") final Long loanId,
        ...
        if (template) {
            ...
            invoiceTypeOptions = this.dropdownReadPlatformService.retrieveLoanInvoiceTypeOptions();
