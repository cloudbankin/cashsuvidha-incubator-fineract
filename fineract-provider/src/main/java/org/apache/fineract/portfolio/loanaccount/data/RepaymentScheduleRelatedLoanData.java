...
public class RepaymentScheduleRelatedLoanData {
    ...
    private final BigDecimal totalInterestBrokenChargesAtDisbursement;
    ...
    public RepaymentScheduleRelatedLoanData(final LocalDate expectedDisbursementDate, final LocalDate actualDisbursementDate,
            ...
            final BigDecimal inArrearsTolerance, final BigDecimal totalFeeChargesAtDisbursement ,final BigDecimal totalInterestBrokenChargesAtDisbursement) {
        ...
        this.totalInterestBrokenChargesAtDisbursement = totalInterestBrokenChargesAtDisbursement;
    }
    ...
    public BigDecimal getTotalInterestBrokenChargesAtDisbursement() {
        return this.totalInterestBrokenChargesAtDisbursement;
 }


    public DisbursementData disbursementData() {
        BigDecimal waivedChargeAmount = null;
        return new DisbursementData(null, this.expectedDisbursementDate, this.actualDisbursementDate, this.principal, null, null, waivedChargeAmount, null);
    }
}