...
public class EarlyPaymentLoanRepaymentScheduleTransactionProcessor extends AbstractLoanRepaymentScheduleTransactionProcessor {
    ...
    protected Money handleTransactionThatIsPaymentInAdvanceOfInstallment(final LoanRepaymentScheduleInstallment currentInstallment,
            ...
            final List<LoanTransactionToRepaymentScheduleMapping> transactionMappings, final boolean isExcludeCharges, final Set<HabLoanRepaymentSchedule> habLoanRepaymentSchedule
    ...
    protected Money handleTransactionThatIsALateRepaymentOfInstallment(final LoanRepaymentScheduleInstallment currentInstallment,
            final List<LoanRepaymentScheduleInstallment> installments, final LoanTransaction loanTransaction,
            final Money transactionAmountUnprocessed, List<LoanTransactionToRepaymentScheduleMapping> transactionMappings, final boolean isExculdeCharges, 
            final Set<HabLoanRepaymentSchedule> habLoanRepaymentSchedule, final boolean isRepaymentCharge) {
