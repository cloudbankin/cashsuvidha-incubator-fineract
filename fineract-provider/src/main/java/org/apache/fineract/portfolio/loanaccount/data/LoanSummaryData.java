...
public class LoanSummaryData {
    ...
    private final BigDecimal interestBrokenChargesDueAtDisbursementCharged;
    ...
    public LoanSummaryData(final CurrencyData currency, final BigDecimal principalDisbursed, final BigDecimal principalPaid,
            ...
            final BigDecimal feeChargesCharged, final BigDecimal feeChargesDueAtDisbursementCharged, final BigDecimal interestBrokenChargesDueAtDisbursementCharged, final BigDecimal feeChargesPaid,
        ...
        this.interestBrokenChargesDueAtDisbursementCharged = interestBrokenChargesDueAtDisbursementCharged;
