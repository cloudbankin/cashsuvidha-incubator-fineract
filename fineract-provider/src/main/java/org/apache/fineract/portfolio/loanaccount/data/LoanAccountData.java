...
public class LoanAccountData {
    ...
    private final EnumOptionData invoiceType;
    ...
    private final BigDecimal amountReturn;
    ...
    private final Collection<EnumOptionData> invoiceTypeOptions;
    ...
    private final BigDecimal interestBrokenChargesAtDisbursementCharged;
    ...
    public static LoanAccountData collateralTemplate(final Collection<CodeValueData> loanCollateralOptions) {
        ...
        final EnumOptionData invoiceType = null;
        ...
        final BigDecimal amountReturn = null;
        ...
        final BigDecimal interestBrokenChargesAtDisbursementCharged = null;
        ...
        final Collection<EnumOptionData> invoiceTypeOptions = null;
        ...
        return new LoanAccountData(id, accountNo, status, externalId, clientId, clientAccountNo, clientName, clientOfficeId, group,
                ...
                graceOnInterestCharged, interestChargedFromDate, amountReturn, timeline, summary, feeChargesDueAtDisbursementCharged, interestBrokenChargesAtDisbursementCharged, repaymentSchedule,
                ...
                transactionProcessingStrategyOptions, interestRateFrequencyTypeOptions, amortizationTypeOptions, interestTypeOptions,invoiceTypeOptions,
    ...
    public static LoanAccountData clientDefaults(final Long clientId, final String clientAccountNo, final String clientName,
        ...
        return new LoanAccountData(id, accountNo, status, externalId, clientId, clientAccountNo, clientName, clientOfficeId, group,
                ...
                transactions, charges, collateral, guarantors, calendarData, productOptions, termFrequencyTypeOptions,
                repaymentFrequencyTypeOptions, repaymentFrequencyNthDayTypeOptions, repaymentFrequencyDayOfWeekTypeOptions,
                repaymentStrategyOptions, interestRateFrequencyTypeOptions, amortizationTypeOptions, interestTypeOptions, invoiceTypeOptions,
                interestCalculationPeriodTypeOptions, fundOptions, chargeOptions, chargeTemplate, loanOfficerOptions, loanPurposeOptions,
                loanCollateralOptions, calendarOptions, syncDisbursementWithMeeting, loancounter, loanProductCounter, notes,
                accountLinkingOptions, linkedAccount, disbursementData, multiDisburseLoan, canDefineInstallmentAmount, fixedEmiAmount,
                maxOutstandingLoanBalance, emiAmountVariations, memberVariations, product, inArrears, graceOnArrearsAgeing, overdueCharges,
    ...
    public static LoanAccountData populateClientDefaults(final LoanAccountData acc, final LoanAccountData clientAcc) {
        ...
        return new LoanAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, clientAcc.clientId, clientAcc.clientAccountNo,
                ...
                acc.amortizationType, acc.interestRatePerPeriod, acc.interestRateFrequencyType, acc.annualInterestRate, acc.interestType, acc.invoiceType,
                ...
                acc.graceOnInterestPayment, acc.graceOnInterestCharged, acc.interestChargedFromDate, acc.amountReturn, clientAcc.timeline, acc.summary,
                acc.feeChargesAtDisbursementCharged, acc.interestBrokenChargesAtDisbursementCharged, acc.repaymentSchedule, acc.transactions, acc.charges, acc.collateral, acc.guarantors,
                ...
                acc.interestTypeOptions, acc.invoiceTypeOptions, acc.interestCalculationPeriodTypeOptions, acc.fundOptions, acc.chargeOptions, null,
    ...
    public static LoanAccountData populateGroupDefaults(final LoanAccountData acc, final LoanAccountData groupAcc) {
        ...
        return new LoanAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, acc.clientId, acc.clientAccountNo, acc.clientName,
                ...
                acc.interestRatePerPeriod, acc.interestRateFrequencyType, acc.annualInterestRate, acc.interestType, acc.invoiceType,
                acc.isFloatingInterestRate, acc.interestRateDifferential, acc.interestCalculationPeriodType,
                acc.allowPartialPeriodInterestCalcualtion, acc.expectedFirstRepaymentOnDate, acc.graceOnPrincipalPayment, acc.recurringMoratoriumOnPrincipalPeriods,
                acc.graceOnInterestPayment, acc.graceOnInterestCharged, acc.interestChargedFromDate, acc.amountReturn, groupAcc.timeline, acc.summary,
                acc.feeChargesAtDisbursementCharged, acc.interestBrokenChargesAtDisbursementCharged, acc.repaymentSchedule, acc.transactions, acc.charges, acc.collateral, acc.guarantors,
                acc.meeting, acc.productOptions, acc.termFrequencyTypeOptions, acc.repaymentFrequencyTypeOptions,
                acc.repaymentFrequencyNthDayTypeOptions, acc.repaymentFrequencyDaysOfWeekTypeOptions,
                acc.transactionProcessingStrategyOptions, acc.interestRateFrequencyTypeOptions, acc.amortizationTypeOptions,
    ...
    public static LoanAccountData loanProductWithTemplateDefaults(final LoanProductData product,
            ...
            final Collection<EnumOptionData> interestTypeOptions, final Collection<EnumOptionData> invoiceTypeOptions, final Collection<EnumOptionData> interestCalculationPeriodTypeOptions,
        ...
        return new LoanAccountData(id, accountNo, status, externalId, clientId, clientAccountNo, clientName, clientOfficeId, group,
                ...
                product.getInterestRateFrequencyType(), product.getAnnualInterestRate(), product.getInterestType(),product.getInvoiceType(),
                ...
                product.getGraceOnInterestCharged(), interestChargedFromDate, amountReturn, timeline, summary, feeChargesDueAtDisbursementCharged, interestBrokenChargesAtDisbursementCharged,
    ...
    public static LoanAccountData populateLoanProductDefaults(final LoanAccountData acc, final LoanProductData product) {
        ...
        return new LoanAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, acc.clientId, acc.clientAccountNo, acc.clientName,
                ...
                product.getAnnualInterestRate(), product.getInterestType(), product.getInvoiceType(), product.isFloatingInterestRateCalculationAllowed(),
                ...
                product.getGraceOnInterestPayment(), product.getGraceOnInterestCharged(), acc.interestChargedFromDate, acc.amountReturn, acc.timeline,
                acc.summary, acc.feeChargesAtDisbursementCharged, acc.interestBrokenChargesAtDisbursementCharged, repaymentSchedule, transactions, charges, collateral, guarantors,
    ...
    public static LoanAccountData basicLoanDetails(final Long id, final String accountNo, final LoanStatusEnumData status,
            ...
            final BigDecimal annualInterestRate, final EnumOptionData interestType, final EnumOptionData invoiceType, final boolean isFloatingInterestRate,
            ...
            final LocalDate interestChargedFromDate, final BigDecimal amountReturn, final LoanApplicationTimelineData timeline, final LoanSummaryData loanSummary,
            final BigDecimal feeChargesDueAtDisbursementCharged, final BigDecimal interestBrokenChargesAtDisbursementCharged, final Boolean syncDisbursementWithMeeting, final Integer loancounter,
        ...
        return new LoanAccountData(id, accountNo, status, externalId, clientId, clientAccountNo, clientName, clientOfficeId, group,
                ...
                annualInterestRate, interestType, invoiceType, isFloatingInterestRate, interestRateDifferential, interestCalculationPeriodType,
                allowPartialPeriodInterestCalcualtion, expectedFirstRepaymentOnDate, graceOnPrincipalPayment, recurringMoratoriumOnPrincipalPeriods, graceOnInterestPayment,
                graceOnInterestCharged, interestChargedFromDate, amountReturn, timeline, loanSummary, feeChargesDueAtDisbursementCharged, interestBrokenChargesAtDisbursementCharged,
                repaymentSchedule, transactions, charges, collateral, guarantors, calendarData, productOptions, termFrequencyTypeOptions,
                repaymentFrequencyTypeOptions, repaymentFrequencyNthDayTypeOptions, repaymentFrequencyDayOfWeekTypeOptions,
                repaymentStrategyOptions, interestRateFrequencyTypeOptions, amortizationTypeOptions, interestTypeOptions, invoiceTypeOptions,
                interestCalculationPeriodTypeOptions, fundOptions, chargeOptions, chargeTemplate, loanOfficerOptions, loanPurposeOptions,
    ...
    public static LoanAccountData associationsAndTemplate(final LoanAccountData acc, final LoanScheduleData repaymentSchedule,
        ...
        return new LoanAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, acc.clientId, acc.clientAccountNo, acc.clientName,
                ...
                acc.isFloatingInterestRate, acc.interestRateDifferential, acc.interestCalculationPeriodType,
                acc.allowPartialPeriodInterestCalcualtion, acc.expectedFirstRepaymentOnDate, acc.graceOnPrincipalPayment, acc.recurringMoratoriumOnPrincipalPeriods,
                acc.graceOnInterestPayment, acc.graceOnInterestCharged, acc.interestChargedFromDate, acc.amountReturn, acc.timeline, acc.summary,
                acc.feeChargesAtDisbursementCharged, acc.interestBrokenChargesAtDisbursementCharged, repaymentSchedule, transactions, charges, collateral, guarantors, calendarData,
                ...
                amortizationTypeOptions, interestTypeOptions, invoiceTypeOptions, interestCalculationPeriodTypeOptions, fundOptions, chargeOptions,
    ...
    public static LoanAccountData withLoanCalendarData(final LoanAccountData acc, final CalendarData calendarData) {
        return new LoanAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, acc.clientId, acc.clientAccountNo, acc.clientName,
                ...
                acc.interestChargedFromDate, acc.amountReturn, acc.timeline, acc.summary, acc.feeChargesAtDisbursementCharged, acc.interestBrokenChargesAtDisbursementCharged, acc.repaymentSchedule,
                ...
                acc.interestRateFrequencyTypeOptions, acc.amortizationTypeOptions, acc.interestTypeOptions, acc.invoiceTypeOptions,
    ...
    private LoanAccountData(final Long id, //
            ...
            final Integer graceOnPrincipalPayment, final Integer recurringMoratoriumOnPrincipalPeriods, final Integer graceOnInterestPayment, final Integer graceOnInterestCharged,
            final LocalDate interestChargedFromDate,final BigDecimal amountReturn, final LoanApplicationTimelineData timeline, final LoanSummaryData summary, final BigDecimal feeChargesDueAtDisbursementCharged,final BigDecimal interestBrokenChargesAtDisbursementCharged,
        ...
        this.interestBrokenChargesAtDisbursementCharged = interestBrokenChargesAtDisbursementCharged;
    ...
    public RepaymentScheduleRelatedLoanData repaymentScheduleRelatedData() {
        return this.timeline.repaymentScheduleRelatedData(this.currency, this.principal, this.approvedPrincipal, this.inArrearsTolerance,
                this.feeChargesAtDisbursementCharged,this.interestBrokenChargesAtDisbursementCharged);
    }
