...
public class LoanEnumerations {
    ...
    public static EnumOptionData loanEnumueration(final String typeName, final int id) {
        ...
        }else if (typeName.equals(INVOICE_TYPE)) {
    ...
    public static EnumOptionData invoiceType(final Integer id) {
        return invoiceType(InvoiceMethod.fromInt(id));
   }

   public static EnumOptionData invoiceType(final InvoiceMethod type) {
       EnumOptionData optionData = null;
       switch (type) {
           case INVOICE_FINANCING:
               optionData = new EnumOptionData(InvoiceMethod.INVOICE_FINANCING.getValue().longValue(), InvoiceMethod.INVOICE_FINANCING.getCode(), "Invoice Financing");
           break;
           case OTHERS:
               optionData = new EnumOptionData(InvoiceMethod.OTHERS.getValue().longValue(),
               		InvoiceMethod.OTHERS.getCode(), "Others");
           break;
           default:
               optionData = new EnumOptionData(InvoiceMethod.INVALID.getValue().longValue(), InvoiceMethod.INVALID.getCode(), "Invalid");
           break;
      }
       return optionData;
   }
