...
public class LoanScheduleParams {
    ...
    private Money totalInterestBrokenChargesCharged;
    ...
    private LoanScheduleParams(final int periodNumber, final int instalmentNumber, int loanTermInDays, LocalDate periodStartDate,
            ...
            final Money totalFeeChargesCharged, final Money totalInterestBrokenChargesCharged, final Money totalPenaltyChargesCharged, final Money totalRepaymentExpected,
    ...
    public static LoanScheduleParams createLoanScheduleParamsForPartialUpdate(final int periodNumber, final int instalmentNumber,
            ...
            final Money totalCumulativeInterest, final Money totalFeeChargesCharged,final Money totalInterestBrokenChargesCharged, final Money totalPenaltyChargesCharged,
        ...
        return new LoanScheduleParams(periodNumber, instalmentNumber, loanTermInDays, periodStartDate, actualRepaymentDate,
                totalCumulativePrincipal, totalCumulativeInterest, totalFeeChargesCharged, totalInterestBrokenChargesCharged, totalPenaltyChargesCharged,
    ...
    public static LoanScheduleParams createLoanScheduleParamsForCompleteUpdate(final Collection<RecalculationDetail> recalculationDetails,
        ...
        final Money totalInterestBrokenChargesCharged = null;
    ...
    public static LoanScheduleParams createLoanScheduleParams(final MonetaryCurrency currency, final Money chargesDueAtTimeOfDisbursement, final Money interestBrokenChargesDueAtTimeOfDisbursement,
        ...
        final Money totalInterestBrokenChargesCharged = interestBrokenChargesDueAtTimeOfDisbursement;
    ...
    public Money getTotalInterestBrokenChargesCharged() {
        return this.totalInterestBrokenChargesCharged;
       }

     public void addTotalInterestBrokenChargesCharged(final Money totalInterestBrokenChargesCharged) {
          this.totalInterestBrokenChargesCharged = this.totalInterestBrokenChargesCharged.plus(totalInterestBrokenChargesCharged);
      } 
