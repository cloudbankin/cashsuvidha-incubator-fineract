...
public class LoanDisbursementDetails extends AbstractPersistableCustom<Long> {
    ...
    private BigDecimal interestBrokenChargeTranche;

    protected LoanDisbursementDetails() {

    }

    public LoanDisbursementDetails(final Date expectedDisbursementDate, final Date actualDisbursementDate, final BigDecimal principal ,final BigDecimal interestBrokenChargeTranche) {
    ...
    public void updateinterestBrokenChargeTranche(final BigDecimal interestBrokenChargeTranche) {
    	this.interestBrokenChargeTranche = interestBrokenChargeTranche;
    }
    ...
    public void copy(final LoanDisbursementDetails disbursementDetails) {
        ...
        this.interestBrokenChargeTranche = disbursementDetails.interestBrokenChargeTranche;
    }
    ...
    public BigDecimal getInterestBrokenTranche() {
        return this.interestBrokenChargeTranche;
    }
    ...
    public DisbursementData toData() {
        ...
        return new DisbursementData(getId(), expectedDisburseDate, actualDisburseDate, this.principal, null, null, waivedChargeAmount, null);
    }
