...
public class LoanScheduleAssembler {
    ...
    private LoanApplicationTerms assembleLoanApplicationTermsFrom(final JsonElement element, final LoanProduct loanProduct) {
        ...
        final Integer invoiceType = this.fromApiJsonHelper.extractIntegerWithLocaleNamed("invoiceType", element);
        final InvoiceMethod invoiceMethod = InvoiceMethod.fromInt(invoiceType);
        ...
        final BigDecimal amountReturn = this.fromApiJsonHelper.extractBigDecimalWithLocaleNamed("amountReturn", element);
        ...
        return LoanApplicationTerms.assembleFrom(applicationCurrency, loanTermFrequency, loanTermPeriodFrequencyType, numberOfRepayments,
                repaymentEvery, repaymentPeriodFrequencyType, nthDay, weekDayType, amortizationMethod, interestMethod, invoiceMethod,
                ...
                interestChargedFromDate, amountReturn, inArrearsToleranceMoney, loanProduct.isMultiDisburseLoan(), emiAmount, disbursementDatas,
        ...
        if (command.has(LoanApiConstants.disbursementDataParameterName)) {
            ...
            if (disbursementDataArray != null && disbursementDataArray.size() > 0) {
                ...
                do {
                    ...
                    disbursementDatas.add(new DisbursementData(null, expectedDisbursementDate, null, principal, null, null, waivedChargeAmount, null));
                    i++;
