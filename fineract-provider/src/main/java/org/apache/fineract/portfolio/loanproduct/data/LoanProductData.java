...
public class LoanProductData {
    ...
    private final List<EnumOptionData> invoiceTypeOptions;
    ...
    public static LoanProductData lookup(final Long id, final String name, final Boolean multiDisburseLoan ) {
        ...
        return new LoanProductData(id, name, shortName, description, currency, principal, minPrincipal, maxPrincipal, tolerance,
                ...
                amortizationType, interestType,  invoiceType, interestCalculationPeriodType, allowPartialPeriodInterestCalcualtion, fundId, fundName,
    ...
    public static LoanProductData sensibleDefaultsForNewLoanProductCreation() {
        ...
        final EnumOptionData invoiceType = LoanEnumerations.invoiceType(InvoiceMethod.OTHERS);
    ...
    public LoanProductData(final Long id, final String name, final String shortName, final String description, final CurrencyData currency,
            ...
            final EnumOptionData interestRateFrequencyType, final EnumOptionData amortizationType, final EnumOptionData interestType, final EnumOptionData invoiceType,
    ...
    public LoanProductData(final LoanProductData productData, final Collection<ChargeData> chargeOptions,
            ...
            final List<EnumOptionData> interestTypeOptions, final List<EnumOptionData> invoiceTypeOptions, final List<EnumOptionData> interestCalculationPeriodTypeOptions,
        ...
        this.invoiceType = productData.invoiceType;
	...
	public EnumOptionData getInvoiceType() {
	...
	public List<EnumOptionData> getInvoiceTypeOptions() {
		return this.invoiceTypeOptions;
	}
