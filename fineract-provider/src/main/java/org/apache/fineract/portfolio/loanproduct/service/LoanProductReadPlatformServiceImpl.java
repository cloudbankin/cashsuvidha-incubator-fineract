    ...
    private static final class LoanProductMapper implements RowMapper<LoanProductData> {
        ...
        public String loanProductSchema() {
            return "lp.id as id, lp.fund_id as fundId, f.name as fundName, lp.loan_transaction_strategy_id as transactionStrategyId, ltps.name as transactionStrategyName, "
                    ...
                    + "lp.annual_nominal_interest_rate as annualInterestRate, lp.interest_method_enum as interestMethod, lp.invoice_method_enum as invoiceMethod, lp.interest_calculated_in_period_enum as interestCalculationInPeriodMethod,lp.allow_partial_period_interest_calcualtion as allowPartialPeriodInterestCalcualtion, "
                    ...
                    + "lca.id as lcaId, lca.amortization_method_enum as amortizationBoolean, lca.interest_method_enum as interestMethodConfigBoolean, lca.invoice_method_enum as invoiceMethodConfigBoolean, "
        ...
        public LoanProductData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            final int invoiceTypeId = JdbcSupport.getInteger(rs, "invoiceMethod");
            final EnumOptionData invoiceType = LoanEnumerations.invoiceType(invoiceTypeId);
            ...
            final boolean invoiceMethod = rs.getBoolean("invoiceMethodConfigBoolean");
            ...
            allowAttributeOverrides = new LoanProductConfigurableAttributes(amortization, interestMethod, invoiceMethod, transactionProcessingStrategy,
            ...
            return new LoanProductData(id, name, shortName, description, currency, principal, minPrincipal, maxPrincipal, tolerance,
                    ...
                    interestRateFrequencyType, amortizationType, interestType, invoiceType, interestCalculationPeriodType,
