...
public class LoanSchedulePeriodData {
    ...
    public static LoanSchedulePeriodData disbursementOnlyPeriod(final LocalDate disbursementDate, final BigDecimal principalDisbursed,
            final BigDecimal feeChargesDueAtTimeOfDisbursement, final BigDecimal interestBrokenChargesDueAtTimeOfDisbursement, final boolean isDisbursed) {
        final Integer periodNumber = null;
        final LocalDate from = null;
        return new LoanSchedulePeriodData(periodNumber, from, disbursementDate, principalDisbursed, feeChargesDueAtTimeOfDisbursement, interestBrokenChargesDueAtTimeOfDisbursement,
                isDisbursed);
    }
    ...
    private LoanSchedulePeriodData(final Integer periodNumber, final LocalDate fromDate, final LocalDate dueDate,
            final BigDecimal principalDisbursed, final BigDecimal chargesDueAtTimeOfDisbursement, final BigDecimal interestBrokenChargesDueAtTimeOfDisbursement, final boolean isDisbursed) {
        ...
        this.interestOriginalDue = interestBrokenChargesDueAtTimeOfDisbursement;
        ...
        if (isDisbursed) {
            ...
            this.interestPaid = interestBrokenChargesDueAtTimeOfDisbursement;
            ...
            this.interestOutstanding = interestBrokenChargesDueAtTimeOfDisbursement;
        }
        ...
        this.totalOriginalDueForPeriod = chargesDueAtTimeOfDisbursement.add(interestBrokenChargesDueAtTimeOfDisbursement);
        this.totalDueForPeriod = chargesDueAtTimeOfDisbursement.add(interestBrokenChargesDueAtTimeOfDisbursement);
        if( this.feeChargesPaid != null){
         	this.totalPaidForPeriod = this.feeChargesPaid.add(this.interestPaid);
         }
        else{
        ...
        if( this.feeChargesOutstanding != null){
        	  this.totalOutstandingForPeriod = this.feeChargesOutstanding.add(this.interestOutstanding);
        }
      else{
    ...
    public BigDecimal interestOriginalDue() {
        return defaultToZeroIfNull(this.interestOriginalDue);
    }
