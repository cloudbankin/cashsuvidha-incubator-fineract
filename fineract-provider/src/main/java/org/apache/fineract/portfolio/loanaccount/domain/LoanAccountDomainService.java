...
public interface LoanAccountDomainService {
    ...
    LoanTransaction makeRepayment(Loan loan, CommandProcessingResultBuilder builderResult, LocalDate transactionDate,
            ...
            ,boolean isActiveMailRepaymentRecipt,boolean isActiveMailClosure, boolean isExculdeCharges, final boolean isRepaymentCharge);
    ...
    LoanTransaction makeChargePayment(Loan loan, Long chargeId, LocalDate transactionDate, BigDecimal transactionAmount,
            PaymentDetail paymentDetail, String noteText, String txnExternalId, Integer transactionType, Integer installmentNumber, final boolean isExcludeCharges, final boolean isRepaymentCharge);
    ...
    Map<String, Object> foreCloseLoan(final Loan loan, final LocalDate foreClourseDate, final BigDecimal interestPortion,  String noteText
